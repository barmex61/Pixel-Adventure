...
const val SPIKE_HEAD_BIT : Short = 256
const val FAN_PLATFORM_BIT : Short = 512

enum class GameObject(val categoryBit : Short, val maskBits : Short) {
    CHAINSAW(CHAINSAW_BIT, PLAYER_BIT or GROUND_BIT ),
    PLAYER(PLAYER_BIT, CHAINSAW_BIT or GROUND_BIT or ROCK_HEAD_BIT or FRUIT_BIT or FLAG_BIT or TRAP_BIT or SPIKE_HEAD_BIT or FAN_PLATFORM_BIT),
    FROG(PLAYER_BIT, CHAINSAW_BIT or GROUND_BIT ),
    GROUND(GROUND_BIT, PLAYER_BIT or CHAINSAW_BIT or ROCK_HEAD_BIT or SPIKE_HEAD_BIT),
    ROCK_HEAD(ROCK_HEAD_BIT, PLAYER_BIT or GROUND_BIT),
    SPIKE_HEAD(SPIKE_HEAD_BIT, PLAYER_BIT or GROUND_BIT),
    ...
    FAN_PLATFORM(FAN_PLATFORM_BIT, PLAYER_BIT),
